...
% These features are described further in section \ref{sensor_input} 
...
\subsection{Training Process} \label{training_process}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Chapters/Figures/modi_dis/training_process.png}
...
\subsubsection{Working with Internal Physiological Signals}

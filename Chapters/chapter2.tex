...
\textit{“The unconscious quality of particular informative non-verbal behavioural cues grants a level of authenticity”} \printpublication{pentland_honest_2010} \cite{pentland_honest_2010}
...
\textit{“In other words, nonverbal behavioural cues are the physical, machine detectable evidence of affective phenomena not otherwise accessible to experience, an ideal point for technology and human sciences to meet.”} \printpublication{vinciarelli_towards_2011} \cite{vinciarelli_towards_2011}
...
\textit{"Human emotional life is rich; we can experience a huge number of emotions, possibly a continuum, not just a few for which we have words, like fear, sadness, joy, etc."} \printpublication{perlovsky_aesthetic_2014} \cite{perlovsky_aesthetic_2014}
...
\printpublication{gillies_understanding_2019} \cite{gillies_understanding_2019}

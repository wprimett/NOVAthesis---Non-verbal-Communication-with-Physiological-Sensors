...
class ControllerExperience extends Experience {
  ...
  start() {
    ...
    this.show().then(() => {
      ...
      // this.receive('update_dist_0', value => {
      //   this.setGuiOptions("distance_0", value);
      // });
      // this.sharedParams.addParamListener('distance_0', (value) => this.setGuiOptions("distance_0", value));
    });
  }

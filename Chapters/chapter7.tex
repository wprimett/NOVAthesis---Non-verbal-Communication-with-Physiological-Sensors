...
In this final chapter, we summarise the outcomes in response to the major research goals described in Chapter \ref{cha} in addition to their corresponding publications serving as documentation these works, reviewed externally. We put fourth reflective insights gathered from three major case studies, framed into a cohesive narrative to be extended into future research efforts. Finally, we discuss some of the social implications to be accounted for when applying these theoretical models to a new generation of communication technologies.
...
- Client Distributed Interaction
...
\section{The Case for Integrating Technology with Established Movement Practices}
...
(Non-sensory) garments and wearable accessories are known to support aesthetic engagement, not necessarily in their solitary state, but while being perceived as part of one's overall appearance and contextualised within a social scenario.

In this manner, perhaps it's desirable to shift our perspective away from wearable technology to the normalisation of materials that also happen to be embedded with sensory capabilities, as it is becoming the case with other constituents of modern architecture []. 
...
, thus compiling just over 4 years of investigation. 

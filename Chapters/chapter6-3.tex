...
\chapter{Case Study III: Sound Feedback for Social Distance}
...
\\[-1em]
Material        & \begin{tabular}[c]{@{}l@{}}Minimum \\ Detection Range\end{tabular} & \begin{tabular}[c]{@{}l@{}}Maximum \\ Detection Range\end{tabular} & \begin{tabular}[c]{@{}l@{}}Dropout \\ Rate\end{tabular} \\
\\[-1em]
\hline
\\[-1em]
...
\hline
\end{tabular}
\caption[Comparison of reflected materials]{Comparison of reflected materials from benchmark test recordings. From left to right: ceramic tile, skin from the hand, torso covered by clothing}
